    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                ...
                <footer class="footer">
                    © 2024 Nexus <span class="d-none d-sm-inline-block">- Crafted with <i class="mdi mdi-heart text-danger"></i> by ardhie.</span>
                </footer>
        ...
        <script src="{{asset('assets/pages/rangeslider-init.js')}}"></script>
